        ...
        if (message.member.roles.cache.has('746112824388092038')) {
            if (input_linktype === "group") {
                ...
                if (isNaN(args[1])) { } else {
                    message.channel.send(`Please send $${args[1]} to **andrewhoang2004@protonmail.com** **__AS FRIENDS NOT GOODS__** Once done, please @ andrew. If you'd like to use a different currency other than USD, let us know!`);
                }
            }
