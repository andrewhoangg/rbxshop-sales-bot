        ...
        fetch(`https://economy.roblox.com/v1/groups/${groupID}/currency/`).then(function(response) {
            response.text().then(function(stock) {
                ...
                if (parsedstock === 0)
                {
                    ...
                    embed.setDescription("Oops! Due to high demand, we're currently out of stock! Restocks usually occur every few hours, it depends when our funds get unpended. If you would like to purchase, please create a ticket in #purchase-robux. Make sure to @ <@689231007932481550> or <@699361519535915149> in your ticket for faster response!")
                ...
                else
                {
                    ...
                    embed.setDescription('We currently have robux in stock! If you would like to purchase, please create a ticket in #purchase-robux. Make sure to <@689231007932481550> or <@699361519535915149> in your ticket for faster response!')
